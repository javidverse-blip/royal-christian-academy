      ...
      <section className="py-12 px-4 sm:px-8 sm:py-14 lg:px-16 lg:py-16 bg-white">
        <div className="max-w-7xl mx-auto">
          <div className="text-center max-w-4xl mx-auto mb-10">
            <p className="text-gold font-semibold text-sm tracking-widest uppercase mb-3">A School Born and Thriving From Faith</p>
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-forest font-serif mb-4">
              A humble beginning
            </h2>
            <blockquote className="text-gold text-xl sm:text-2xl font-serif italic leading-relaxed">
