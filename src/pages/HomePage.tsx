...
const programs = [
  { icon: '🍽️', title: 'Feeding Program', desc: 'Nutritious meals supporting health, academic performance, and overall well-being.', image: '/Programs/feeding-prog.jpg', imageClass: 'object-[center_42%]' },
  { icon: '🔧', title: 'Vocational Training', desc: 'Hands-on skills fostering self-reliance, entrepreneurship, and sustainable livelihoods.', image: '/Programs/vocational-prog.jpg', imageClass: 'object-[center_38%]' },
  { icon: '🌿', title: 'Health Ministry', desc: 'Natural health principles, preventive healthcare, and healthy lifestyle education.', image: '/Programs/health-min.jpg', imageClass: 'object-center' },
  { icon: '📖', title: 'Bible Training', desc: 'Biblical education, discipleship, and character formation for Christian service.', image: '/Programs/bible-train.jpg', imageClass: 'object-center' },
  { icon: '🤝', title: 'Community Outreach', desc: "Evangelism, humanitarian assistance, and reflecting Christ's love in action.", image: '/Programs/community-outreach.png', imageClass: 'object-center' },
  { icon: '🌱', title: 'Agriculture & Farming', desc: 'Sustainable farming, environmental stewardship, and responsible land management.', image: '/Programs/agriculture-farmimg.jpg', imageClass: 'object-center' },
];
...
/* Hero section */
function Hero({ navigate }: { navigate: (p: any) => void }) {
  return (
...
/* Welcome section */
function WelcomeSection({ navigate }: { navigate: (p: any) => void }) {
...
function MissionVision({ navigate }: { navigate: (p: any) => void }) {
  const ref = useScrollAnimation();
  return (
...
function ProgramsPreview({ navigate }: { navigate: (p: any) => void }) {
  const ref = useScrollAnimation();
  return (
