...
const programs = [
  {
    ...
    image: '/Programs/feeding-prog.jpg',
  ...
  },
  {
    ...
    image: '/Programs/vocational-prog.jpg',
  ...
  },
  {
    ...
    image: '/Programs/bible-train.jpg',
    imageClass: 'object-center',
  },
  {
    number: '05',
    ...
    image: '/Programs/community-outreach.png',
    imageClass: 'object-center',
  },
  {
    number: '06',
    ...
    image: '/Programs/agriculture-farmimg.jpg',
    imageClass: 'object-center',
  },
];
      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="grid grid-cols-2 gap-4">
            <StudentLifePhoto src="/mng-worship.jpg" alt="Morning Worship" />
            <StudentLifePhoto src="/Programs/community-outreach.png" alt="Community Service" />
            <StudentLifePhoto src="/Programs/health-min.jpg" alt="Health Ministry" />
            <StudentLifePhoto src="/Programs/agriculture-farmimg.jpg" alt="Farm Projects" />
          </div>
        </div>
      </div>
    </section>
